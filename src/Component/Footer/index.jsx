                        ...
                        <nav className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 max-w-6xl mx-auto">
                              <div>
                                    ...
                                    <p className="mt-2 text-gray-400 max-w-xl">
                                          Heaven fruitful doesn't over lesser
                                          days. Creeping seasons so behold
                                          bearing.
                                    </p>
                              </div>
                              <div>
                              ...
                              <div>
                                    ...
                                    <div className="text-gray-400 my-4">
                                          ...
                                          Reach out to us and our team will get
                                          back to you promptly.
                                    </div>
                                    <button
                                          onClick={handleContact}
                                          className="border font-bold rounded-md px-6 py-2 text-white bg-[#0C3B57]"
                                    >
                                          Contact
                                    </button>
                              </div>
